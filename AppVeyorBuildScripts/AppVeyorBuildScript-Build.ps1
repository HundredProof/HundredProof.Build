...
$nuSpecFileAnalyzer = Resolve-Path ./Analyzers/HundredProof.Build.Analyzers.nuspec
$nuSpecFilePackaging = Resolve-Path ./Packaging/HundredProof.Build.Packaging.nuspec
$nuSpecFileConventionsRepoConfig = Resolve-Path ./Conventions/HundredProof.Build.Conventions.RepoConfig.nuspec
$nuSpecFileConventionsReSharper = Resolve-Path ./Conventions/HundredProof.Build.Conventions.ReSharper.nuspec
